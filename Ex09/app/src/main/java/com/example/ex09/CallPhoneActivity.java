...
public class CallPhoneActivity extends AppCompatActivity {
    ...
    Button btnback1; @SuppressLint("WrongViewCast")
    @Override

    protected void onCreate(Bundle savedInstanceState) { super.onCreate(savedInstanceState); setContentView(R.layout.activity_call_phone);
...
// Yêu cầu người dùng đồng ý quyền truy cập vào tính năng gọi điện
        ...
        btnback1.setOnClickListener(new View.OnClickListener() { @Override
